...
class GoodsOrder extends Base
{
    ...
    {
        $fields = "a.out_trade_no as no,a.serial_num,a.user_id,c.username,a.money,a.goods_id,b.subject,a.create_time,c.mobile,c.email,c.city,c.detail_address,d.name as status,(CASE invoice_type WHEN 2 THEN '公司' when 1 THEN '个人' else '不开发票' end) as invoice_type,c.invoice_title,c.pay_taxes_id,c.user_msg";
        $offset = ($page - 1) * $rows;
        $total = $this->count();
