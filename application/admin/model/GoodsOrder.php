...
class GoodsOrder extends Base
{
    ...
    {
        $fields = 'a.out_trade_no as no,a.serial_num,a.user_id,c.username,a.money,a.goods_id,b.subject,a.create_time,c.mobile,c.email,c.city,c.detail_address,d.name as status';
        $offset = ($page - 1) * $rows;
        $total = $this->count();
